...
class NGramLanguageModeler(nn.Module):
    ...
    def forward(self, inputs):
        embeds = self.embeddings(inputs).view((1, -1))#pytorch的embedding是把单个字符转化为embeddingsize，所以转换为1行后的size为context_size*embedding_dim
...
idx_to_word = {word_to_ix[word]:word for word in vocab}
